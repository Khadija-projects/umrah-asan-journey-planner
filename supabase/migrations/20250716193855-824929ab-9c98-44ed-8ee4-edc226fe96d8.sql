...
(
  ...
  'authenticated',
  'guest@umrahasan.com',
  '$2a$10$FdE6E3m0G7Z5Qf8zNpT0hOGJhL5CdE0P8kR6qM3nT9sV2uX7y4wZ1', -- demo123
  now(),
  now(),
  now(),
...
(
  ...
  'authenticated',
  'admin@umrahasan.com',
  '$2a$10$GfF7F4n1H8A6Rf9aNqU1iOHKiM6DeF1Q9lS7rN4oU0tW3vY8z5xA2', -- admin123
  now(),
  now(),
  now(),
  '{"provider": "email", "providers": ["email"]}',
...
(
  ...
  '$2a$10$HgG8G5o2I9B7Sg0bOrV2jOILjN7EfG2R0mT8sO5pV1uX4wZ9a6yB3', -- partner123
  now(),
  now(),
  now(),
  '{"provider": "email", "providers": ["email"]}',
